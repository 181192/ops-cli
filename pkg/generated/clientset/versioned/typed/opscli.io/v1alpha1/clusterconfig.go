...
type ClusterConfigInterface interface {
	Create(ctx context.Context, clusterConfig *v1alpha1.ClusterConfig, opts v1.CreateOptions) (*v1alpha1.ClusterConfig, error)
	Update(ctx context.Context, clusterConfig *v1alpha1.ClusterConfig, opts v1.UpdateOptions) (*v1alpha1.ClusterConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ClusterConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ClusterConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterConfig, err error)
...
func newClusterConfigs(c *OpscliV1alpha1Client) *clusterConfigs {
...
func (c *clusterConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterConfig, err error) {
...
func (c *clusterConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterConfigList, err error) {
...
func (c *clusterConfigs) Create(ctx context.Context, clusterConfig *v1alpha1.ClusterConfig, opts v1.CreateOptions) (result *v1alpha1.ClusterConfig, err error) {
	result = &v1alpha1.ClusterConfig{}
	err = c.client.Post().
		Resource("clusterconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterConfigs) Update(ctx context.Context, clusterConfig *v1alpha1.ClusterConfig, opts v1.UpdateOptions) (result *v1alpha1.ClusterConfig, err error) {
	result = &v1alpha1.ClusterConfig{}
	err = c.client.Put().
		Resource("clusterconfigs").
...
func (c *clusterConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterConfig, err error) {
	result = &v1alpha1.ClusterConfig{}
